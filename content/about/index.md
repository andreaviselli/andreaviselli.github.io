...
- **Forecast evaluation:** equal predictive ability test that are robust to heavy-tailed forecast errors.
- **Forecast combinations** that can adapt to changes in predictive performance over time.
- **Judgmental forecasts** generated by fictional AI agents.
- **Mathematical and ML methods** for innovative applications in economic forecasting.